...
namespace MUnique.Client.Network;
...
public sealed class Connection : PacketPipeReaderBase, IConnection
{
    ...
    public Connection(IDuplexPipe duplexPipe, ILogger<Connection> logger)
    {
        this._duplexPipe = duplexPipe;
        this._logger = logger;
        this.Source = this._duplexPipe!.Input;
    ...
    /// <inheritdoc />
    public PipeWriter Output => this._outputWriter ??= new ExtendedPipeWriter(this._duplexPipe!.Output, OutgoingBytesCounter);
